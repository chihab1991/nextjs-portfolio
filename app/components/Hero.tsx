	...
	return (
		<section id="hero" className="text-center px-6 py-20 container mx-auto ">
			...
			<p className="leading-7 mt-6 md:leading-8">
				Hi, I&apos;m Chergui Chihab Iddine, a dedicated React & Next.js Web
				Developer based in Algeria. With a passion for coding and a commitment
				to excellence, I specialize in crafting dynamic, user-friendly web
